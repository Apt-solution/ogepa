...
<p id="trigger" data-bs-toggle="modal" data-bs-target="#exampleModal"></p>
<!-- Modal -->
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel"><i id="icon" class="fas fa-info-circle mr-2 bg-info"></i>Note</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body bg-info">
        <p class="lead text-sm">If you are accessing this page for the first time, kindly login with your ogwama code and password as "12345678"</p>
