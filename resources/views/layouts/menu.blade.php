...
<div class="sidebar" style="background-color: black;">
    ...
    <li style="margin-bottom: -15px;"><a  href="{{ route('payments') }}" class="text-sm"> <i class="fas fa-receipt"></i> View Payments</a></li>
    <li style="margin-bottom: -15px;"><a  href="{{ route('automatedPrice') }}" class="text-sm"> <i class="fas fa-wallet"></i> Set Automated Payment</a></li>
    <li style="margin-bottom: -15px;"><a href="{{route('checkPayment') }}" class="text-sm">Check Payment</a></li>
    @endif
