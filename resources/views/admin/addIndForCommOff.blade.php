    ...
    <div class="row">
        <div class="card bg-dark h-50">
            <div class="card-heading">
                Add industry for commercial officer
            </div>
        </div>
    </div>
    <div class="row">
        ...
        <div class="col-sm-10">
            ...
            <div class="panel panel-default">
                ...
                @endif
                <div class="panel-heading">Search Industry</div>
                <div class="panel-body">
                    <a href="" class="btn btn-danger">Reset All</a>
                    <div class="myrespons"></div>
                    <div class="form-group">
                        <input type="text" name="search" id="search" class="form-control" placeholder="Search Industry" style="border-radius: 5px 5px 0 0;" />
                    ...
                    <div class="col-sm-12">
                        ...
                        <form method="post" action="{{ url('addIndustryForOfficer') }}" id="form1">
                            {{ csrf_field() }}

                            <div class="form-group">
                                <label for="">Commercial Officer</label>
                                <select name="commercial_officer_id" class="js-example-basic-single form-control" id="">
            ...
            $(document).ready(function() {
                ...
                $(document).on("click", "div.rst", function() {
                    ...
                    if (added.indexOf(name) > -1) {
                        ...
                        $("input#search").val("");
                        tdata = "<tr>"
                        tdata += "<td>" + name + "<input type='hidden' name='name[]' value='" + name + "' class='form-control'/></td>"
                        tdata += "<td>" + phone + "<input type='hidden' name='description[]' value='" + phone + "' class='form-control'/></td>"
                        tdata += "<td>" + user_id + "<input type='hidden' name='user_id[]' value='" + user_id + "' class='form-control'/></td>"
